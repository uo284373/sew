    ...
    cargarDatos(id){
        $.ajax({
            ...
            success: function(datos){
                    ...
                    var imagen = "<img src=https://openweathermap.org/img/wn/" + icono + "@2x.png alt=\"icono del Tiempo "+ciudad+"\"/>";
                    ...
                    $("h2:eq("+id+")").after(imagen);
                    $("img[alt=\"icono del Tiempo "+ciudad+"\"").after(stringDatos);
                },
            error:function(){
